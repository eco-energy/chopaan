  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "fusion-plugin".revision = (((hackage."fusion-plugin")."0.2.2").revisions).default;
        ...
        "haskeline".revision = (((hackage."haskeline")."0.8.1.1").revisions).default;
        ...
        "data-lens-light".revision = (((hackage."data-lens-light")."0.1.2.2").revisions).default;
        "unliftio".revision = (((hackage."unliftio")."0.2.14").revisions).default;
        "xml-conduit".revision = (((hackage."xml-conduit")."1.9.0.0").revisions).default;
        ...
        "compactable".revision = (((hackage."compactable")."0.1.2.3").revisions).default;
        ...
        "greskell".revision = (((hackage."greskell")."1.2.0.0").revisions).default;
        ...
        "dimensional".revision = (((hackage."dimensional")."1.3").revisions).default;
        ...
        "compensated".revision = (((hackage."compensated")."0.8.1").revisions).default;
        "compensated".flags.test-doctests = true;
        ...
        "hspec-golden-aeson".revision = (((hackage."hspec-golden-aeson")."0.7.0.0").revisions).default;
        ...
        "greskell-core".revision = (((hackage."greskell-core")."0.1.3.5").revisions).default;
        ...
        "net-spider".revision = (((hackage."net-spider")."0.4.3.5").revisions).default;
        "net-spider".flags.server-test = false;
        ...
        "quickcheck-classes".revision = (((hackage."quickcheck-classes")."0.6.4.0").revisions).default;
        ...
        "monad-coroutine".revision = (((hackage."monad-coroutine")."0.9.0.4").revisions).default;
        ...
        "quickcheck-classes-base".revision = (((hackage."quickcheck-classes-base")."0.6.1.0").revisions).default;
        "quickcheck-classes-base".flags.binary-laws = true;
        "quickcheck-classes-base".flags.unary-laws = true;
        "ap-normalize".revision = (((hackage."ap-normalize")."0.1.0.0").revisions).default;
        ...
        "numtype-dk".revision = (((hackage."numtype-dk")."0.5.0.2").revisions).default;
        ...
        "safecopy".revision = (((hackage."safecopy")."0.10.3.1").revisions).default;
        ...
        "email-validate".revision = (((hackage."email-validate")."2.3.2.13").revisions).default;
        ...
        "net-mqtt".revision = (((hackage."net-mqtt")."0.7.1.0").revisions).default;
        ...
        "log-domain".revision = (((hackage."log-domain")."0.13").revisions).default;
