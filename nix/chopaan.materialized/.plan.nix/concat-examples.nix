    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optional (flags.smt) (hsPkgs."z3" or (errorHandler.buildDepError "z3"));
        buildable = true;
        modules = [
          ...
          "ConCat/StackVM"
          "ConCat/Distribution"
          ] ++ (pkgs.lib).optional (flags.smt) "ConCat/SMT";
        hsSourceDirs = [ "src" ];
        includeDirs = [ "src" ];
        };
      tests = {
        ...
        "gold-tests" = {
          ...
          buildable = true;
          modules = [ "BasicTests" "Miscellany" "Utils" ];
          hsSourceDirs = [ "test" ];
          mainPath = [ "GoldTests.hs" ];
          };
        };
      };
