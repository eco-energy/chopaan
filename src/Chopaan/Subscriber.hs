...
subStream :: (IsStream t, MonadAsync m) => TChan.TChan (n, a) -> ((n, a) -> Bool) -> (t m a)
...
getStream :: forall t m n a . (Hashable n, Ord n, IsStream t, MonadAsync m) => StreamMap n a -> n -> t m a
