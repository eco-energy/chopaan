-- Actually authored by https://github.com/blackheaven/servant-streamly/blob/master/src/Servant/Streamly.hs
-- Embedding it to save pulling in another dependency :(
