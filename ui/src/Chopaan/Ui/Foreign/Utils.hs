module Chopaan.Ui.Foreign.Utils where
...
import Language.Javascript.JSaddle.Types (MonadJSM, JSVal, JSM, ghcjsPure, jsval, liftJSM)
import Language.Javascript.JSaddle.Object (jsg, new)
